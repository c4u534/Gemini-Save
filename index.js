...
const createPromptHandler = (drive, vertex_ai, contextFileId) => async (req, res) => {
    try {
...
async function startServer() {
  try {
    ...
    app.post('/', createPromptHandler(drive, vertex_ai, CONTEXT_FILE_ID));
...
module.exports = { startServer, createPromptHandler };
